<div class="mt-10">
    <section
        class="mb-3 flex flex-col md:flex-row gap-4 md:gap-0 md:items-center justify-between md:border-l-4 md:border-[#ff78c4] lg:mb-6">
        <div class="flex items-center justify-between border-l-4 border-[#535353] md:border-l-0">
            ...
            <div class="flex items-center gap-2 md:hidden">
                <a class="btn-show-cart flex cursor-pointer uppercase tracking-widest md:hidden gap-2" id="">
                    cart
                    <span><i class="fa-solid fa-cart-shopping text-[#535353]"></i></span>
                </a>
    ...
    <div id="wrapper-all-indicator-group-menu" class="flex justify-center items-center mt-6">
        <button type="button"
            ...
            <span
                class="inline-flex h-8 w-8 items-center justify-center rounded-full bg-[#535353] group-focus:outline-none group-focus:ring-4 group-focus:ring-[#535353]/70 group-focus:ring-white md:h-10 md:w-10 md:group-hover:bg-[#535353]">
