<nav class="border-gray-200 shadow-md bg-white">
    <div class="w-full md:w-4/5 flex flex-wrap items-center justify-between mx-auto p-4 md:py-4 md:px-0">
        <a href="https://flowbite.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
            ...
            <p class="self-center text-2xl font-semibold whitespace-nowrap hidden md:block">Bento <span
                    class="text-[#ff78c4]">Cake</span></p>
        </a>
        <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
            <section class="relative items-center gap-2 pr-[5%] md:flex" id="wrapper-cart">
                <div class="hidden md:flex gap-2 items-center">
                    <a class="btn-show-cart  cursor-pointer uppercase tracking-widest flex gap-2" id="">
                        cart
                        <span><i class="fa-solid fa-cart-shopping text-[#ff78c4]"></i></span>
                    </a>
                    <p class="cart-indicator hidden h-4 w-4 items-center justify-center rounded-full bg-[#535353] text-xs text-white min-[1250px]:h-4 min-[1250px]:w-4 min-[1250px]:text-xs"
                        id=""></p>
                </div>

                <form
                    class="fixed bottom-0 right-0 hidden w-screen rounded-bl-[14px] bg-gray-200 p-2 shadow md:bottom-auto md:right-0 md:top-16 md:w-max min-w-[400px]"
                    id="cart">
                    <div class="mb-2 flex justify-between rounded-[6px] bg-white p-2">
                        ...
                        <div class="cursor-pointer" id="btn-close-cart"><i
                                class="fa-solid fa-x text-base font-normal"></i></div>
                    </div>
                    ...
                    <div class="mt-2 rounded-[6px] bg-white p-2">
                      ...
                      <p class="mr-4">:</p> -->
                            <p class=""><span class="cursor-pointer font-normal italic underline"
                                    id="btn-show-modal">Input data diri</span></p>
                        </section>
                        <section class="mt-2">
                        ...
                        <section class="mt-4 flex items-center gap-2">
                            <button
                                class="g-recaptcha flex-1 rounded bg-gray-600 py-1 text-sm text-white md:hover:bg-gray-700"
                                id="btn-checkout" type="submit">checkout</button>
                            <section class="flex items-center text-sm font-medium">
            ...
            <button type="button"
                ...
                aria-controls="navbar-default" aria-expanded="false" id="btn-navbar">
                <span class="sr-only">Open main menu</span>
                <i class="fa-solid fa-bars text-xl" id="icon-navbar"></i>
            </button>
        </div>
        <div class="hidden w-full md:block md:w-auto" id="navbar-default">
            <ul class="font-medium flex gap-2 flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white"
                id="nav-menu">
                {{-- list page --}}
            </ul>
        </div>
